...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      "projects.smc.title": "Applications immobilier iOS &amp; Android + API Laravel",
      "projects.smc": "Deux applications React Native / Expo, l'une pour les résidences, l'autre pour les maisons et appartements, et leur API Laravel commune (authentification, annonces, médias, notifications). Publication sur l'App Store et Google Play.",
    ...
    en: {
      ...
      "projects.smc.title": "Real-estate iOS &amp; Android apps + Laravel API",
      "projects.smc": "Two React Native / Expo apps, one for residences and one for houses and apartments, plus their shared Laravel API (auth, listings, media, notifications). Published on the App Store and Google Play.",
